...
export function ContactCTA() {
  return (
    <section id="contact" className="bg-midnight py-28 sm:py-40">
      <motion.div
        initial={{ opacity: 0, y: 32 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 0.7 }}
        className="section-shell overflow-hidden border-y border-ice/12 bg-radial-blue px-6 py-20 text-center sm:px-10 sm:py-28 lg:px-20"
      >
        ...
        <p className="editorial-copy mx-auto mt-7 max-w-2xl">
